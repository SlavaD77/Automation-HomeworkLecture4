...
public abstract class BaseTest {
    ...
    protected String getBrowserTypeFromPOM(){
        return myproject.automation.hwlecture4.utils.Properties.getBrowser();
    }

    /**
     *
     * @return String admin login, String admin password
     */
    @DataProvider(name="getLoginPassword")
    public Object[][] getCredentialsFromPOM(){
            return new Object[][]{
                    {Properties.getAdminLogin(),Properties.getAdminPassword()}
            };
    }
