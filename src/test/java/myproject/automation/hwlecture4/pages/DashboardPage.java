...
public class DashboardPage {
    ...
    private By productsCatalogSubtabItem = By.cssSelector("li[data-submenu='10']");

    public By getProductsCatalogSubtabItem() {
        return productsCatalogSubtabItem;
    }

    public void clickProductsCatalogSubtabItem(){
        waitForElementPresence(productsCatalogSubtabItem);
        (driver.findElement(productsCatalogSubtabItem)).click();
    }
    //---------------------------------------------------
