package myproject.automation.hwlecture4.model;
...
/**
 * Hold Product information that is used among myproject.automation.hwlecture4.tests.
 */
public class ProductData {
    ...
    public String getString(){
        return "Name:" + getName() + " qty: " + getQty() + " price: " + getPrice();
    }
}
